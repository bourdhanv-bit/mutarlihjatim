...
// Daftar kode kategori (urutan tetap, dipakai untuk breakdown & nama kolom rekap_triwulan)
export const TMS_CATS = Object.keys(TMS_KATEGORI);
export const BARU_CATS = Object.keys(MS_KATEGORI);
